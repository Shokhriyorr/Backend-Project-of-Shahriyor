...
const dataSlice = createSlice({
  ...
  reducers: {
    ...
    setEnrollments(state, { payload }) {
      state.enrolledIds = payload
    },
    clearEnrollments(state) {
      state.enrolledIds = []
    },

    courseAdded(state, { payload }) {
    ...
    enrolled(state, { payload: courseId }) {
      state.enrolledIds.push(courseId)
    },
