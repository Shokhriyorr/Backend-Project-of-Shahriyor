...
import * as accountApi from '@/features/account/api/accountApi.js'
import { setUser } from '@/features/auth/model/authSlice.js'
...
export default function Account() {
  ...
  const handleProfileSubmit = async (event) => {
    ...
    try {
      const payload = await accountApi.updateMe({ display_name: displayName })
  ...
  const handlePasswordSubmit = async (event) => {
    ...
    try {
      const payload = await accountApi.changePassword(passwordForm)
      dispatch(setUser(payload.data))
      setPasswordForm({
        current_password: '',
        new_password: '',
