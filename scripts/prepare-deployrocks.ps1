...
Write-Host "4) Do not set a Compose file; DeployRocks should use the root Dockerfile"
Write-Host "5) Delete old separate apps ...-api, ...-frontend, and ...-worker if they exist"
Write-Host "6) Retry deploy"
Write-Host ""
